...
This document explains the three main issues encountered during live coding and their solutions.

---

## Issue 1: Migration Scripts Not Working ❌ → ✅
...
## Issue 2: Socket Race Condition with Game Listing ❌ → ✅
...
## Issue 3: Vite Requiring `type="module"` in Script Tags
